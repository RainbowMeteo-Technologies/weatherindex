...
if __name__ == "__main__":
    ...
    rainbow_parser.add_argument("--version", type=str, required=False, default="v1", choices=Rainbow.API_VERSIONS,
                                help=f"Rainbow API version. Values of {Rainbow.API_VERSIONS}")
